...
{
    public abstract class LABAPPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LABAPPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LABAPPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LABAPPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LABAPPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LABAPPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LABAPPDbContext, Task<T>> func)
        {
            T result;
